...
struct Vocabulary
{
	...
	void Learn()
	{
		...
		Words = 
		{
			...
			{ "Pro Poss N Sing", pronouns[6] },{ "Pro Poss N Sing", pronouns[7] },{ "Pro Refl Sing", pronouns[8] },
...
int main()
{
	Vocabulary Toddler;
	Toddler.Learn();
	string sentence = "the car will be blue";
	
	Toddler.Read_Text(sentence);
    return 0;
}
