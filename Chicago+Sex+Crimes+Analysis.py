...
import pandas as pd, numpy as np #for data wrangling
import matplotlib.pyplot as plt #for visualization
import matplotlib.animation as animation #animate plots
from IPython.display import HTML #create mp4 videos
import seaborn as sns #Creating heatmaps
from sklearn import linear_model #for linear model predictions
from sklearn.decomposition import PCA #for PCA
from sklearn.model_selection import train_test_split #to split data int training and testing
from sklearn.metrics import confusion_matrix #confusion matrices
import itertools #help create confusion matrix plots
from sklearn.metrics import accuracy_score #accuracy scores
from sklearn.naive_bayes import BernoulliNB #Naive Bayes Classifier using Bernoulli
